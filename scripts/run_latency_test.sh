...
srun -n 6 -l ./host_aurora_hls_test -p aurora_hls_test_hw_streaming.xclbin -l -i 10 -f 0 $@
...
do 
    srun -n 1 ./scripts/reset.sh
    srun -n 6 -l ./host_aurora_hls_test -p aurora_hls_test_hw.xclbin -l -i 10 -f $frame_size $@
done
