...
srun -n 1 changeFPGAlinksXilinx --fpgalink=n00:acl0:ch1-n00:acl1:ch0 --fpgalink=n00:acl1:ch1-n00:acl2:ch0 --fpgalink=n00:acl2:ch1-n00:acl0:ch0

srun -n 6 -l ./host_aurora_flow_test -m 2 $@
