...
echo "configuring loopback on acl0"
...
changeFPGAlinksXilinx --fpgalink=n00:acl1:ch0-n00:acl2:ch0 --fpgalink=n00:acl0:ch0-n00:acl0:ch0 --fpgalink=n00:acl0:ch1-n00:acl0:ch1 --fpgalink=n00:acl1:ch1-n00:acl2:ch1

./host_aurora_flow_test -d 2 -m 0 -c $@
